...
//###LUZ_0:
static void switch_comp_luz0_ligada_changed(GtkSwitch *_switch, gpointer user_data) { // _switch ? Pq 'switch' é palavra reservada !
    bool value = gtk_switch_get_state(_switch);
...
//###LUZ_1:
static void switch_comp_luz1_ligada_changed(GtkSwitch *_switch, gpointer user_data) { // _switch ? Pq 'switch' é palavra reservada !
    bool value = gtk_switch_get_state(_switch);
    g_print("Bool value changed to: %b\n", value);
    //Sessão crítica !!!
    pthread_mutex_lock(&mutex_gui);
...
//###LUZ_2:
static void switch_comp_luz2_ligada_changed(GtkSwitch *_switch, gpointer user_data) { // _switch ? Pq 'switch' é palavra reservada !
    bool value = gtk_switch_get_state(_switch);
    g_print("Bool value changed to: %b\n", value);
    //Sessão crítica !!!
    pthread_mutex_lock(&mutex_gui);
...
static void activate (GtkApplication *app, gpointer user_data) {
    ...
    GtkWidget *switch_comp_luz0_ligada, *scale_comp_luz0_cor_r, *scale_comp_luz0_cor_g, *scale_comp_luz0_cor_b;

    GtkWidget *label_comp_luz1_ligada, *label_comp_luz1_cor_r, *label_comp_luz1_cor_g, *label_comp_luz1_cor_b;
    GtkWidget *switch_comp_luz1_ligada, *scale_comp_luz1_cor_r, *scale_comp_luz1_cor_g, *scale_comp_luz1_cor_b;

    GtkWidget *label_comp_luz2_ligada, *label_comp_luz2_cor_r, *label_comp_luz2_cor_g, *label_comp_luz2_cor_b;
    GtkWidget *switch_comp_luz2_ligada, *scale_comp_luz2_cor_r, *scale_comp_luz2_cor_g, *scale_comp_luz2_cor_b;
    ...
    g_signal_connect(check_button_comp_tipoRot_0semRot, "value-changed", G_CALLBACK(check_button_comp_tipoRot_0semRot_changed), NULL);
    ...
    g_signal_connect(check_button_comp_tipoRot_0z, "value-changed", G_CALLBACK(check_button_comp_tipoRot_0z_changed), NULL);
    ...
    g_signal_connect(check_button_comp_tipoRot_0y, "value-changed", G_CALLBACK(check_button_comp_tipoRot_0y_changed), NULL);
    ...
    g_signal_connect(check_button_comp_tipoRot_0x, "value-changed", G_CALLBACK(check_button_comp_tipoRot_0x_changed), NULL);
    ...
    switch_comp_luz0_ligada = gtk_switch_new();
    gtk_switch_set_state(GTK_SWITCH(switch_comp_luz0_ligada), comp_luz0_ligada);
    gtk_widget_set_hexpand(switch_comp_luz0_ligada, FALSE); // FALSE pq fica deformado (muito esticado com TRUE)
    gtk_grid_attach(GTK_GRID(grid), label_comp_luz0_ligada, 2, 0, 1, 1);
    gtk_grid_attach(GTK_GRID(grid), switch_comp_luz0_ligada, 3, 0, 1, 1);
    g_signal_connect(switch_comp_luz0_ligada, "state-set", G_CALLBACK(switch_comp_luz0_ligada_changed), NULL);
    ...
    switch_comp_luz1_ligada = gtk_switch_new();
    gtk_switch_set_state(GTK_SWITCH(switch_comp_luz1_ligada), comp_luz1_ligada);
    gtk_widget_set_hexpand(switch_comp_luz1_ligada, FALSE); // FALSE pq fica deformado (muito esticado com TRUE)
    gtk_grid_attach(GTK_GRID(grid), label_comp_luz1_ligada, 2, 4, 1, 1);
    gtk_grid_attach(GTK_GRID(grid), switch_comp_luz1_ligada, 3, 4, 1, 1);
    g_signal_connect(switch_comp_luz1_ligada, "state-set", G_CALLBACK(switch_comp_luz1_ligada_changed), NULL);
    ...
    switch_comp_luz2_ligada = gtk_switch_new();
    gtk_switch_set_state(GTK_SWITCH(switch_comp_luz2_ligada), comp_luz2_ligada);
    gtk_widget_set_hexpand(switch_comp_luz2_ligada, FALSE); // FALSE pq fica deformado (muito esticado com TRUE)
    gtk_grid_attach(GTK_GRID(grid), label_comp_luz2_ligada, 2, 8, 1, 1);
    gtk_grid_attach(GTK_GRID(grid), switch_comp_luz2_ligada, 3, 8, 1, 1);
    g_signal_connect(switch_comp_luz2_ligada, "state-set", G_CALLBACK(switch_comp_luz2_ligada_changed), NULL);

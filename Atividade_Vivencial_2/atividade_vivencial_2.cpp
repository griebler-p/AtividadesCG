...
// Versão Astrolabium:
// Pasta: cd ''
//Compilar: g++ atividade_vivencial_2.cpp -o atividade_vivencial_2 Basico/glad/glad.c -I ../include -L/usr/lib/x86_64-linux-gnu/ -L/usr/lib64 -lGLEW -lGL -lX11 -lglfw -lrt -lm -ldl `pkg-config --cflags --libs gtk4` -std=c++17
// Rodar: ./teste
// Debug:
